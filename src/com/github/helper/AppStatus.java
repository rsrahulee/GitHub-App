...
public class AppStatus {
	...
	public Boolean isRegistered() {
		try {
			if (getSharedStringValue(Constants.AUTH_KEY).equalsIgnoreCase("null"))
				return false;
			else
				return true;
		} catch (Exception e) {
	...
	public String getSharedStringValue(String key) {
		SharedPreferences sp = context.getSharedPreferences(Constants.strFileName, 0);
		String value = sp.getString(key, null);
		Log.i("Fetched ShareValues:::::", value);
		return value;
	}

	public String getSharedUserName(String keyUser) {
		SharedPreferences spUser = context.getSharedPreferences(Constants.strFileName, 0);
		String value = spUser.getString(keyUser, "");
		Log.i("Fetched Share User Name Values:::::", value);
		return value;
	}
	...
	public boolean clearAuthKey(String key) {
	...
	public void saveUserData(String user_name, String user_email, String user_no, boolean b) {
